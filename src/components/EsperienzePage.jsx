...
const Esperienzepage = () => {
  ...
  return (
    ...
    <StyledDiv>
      <Container className="bg-white col-6 containerAll">
        <div className="d-flex position-relative">
          ...
          {showDrop && (
            <div className="drop-down d-flex">
              <ul className="list-unstyled d-flex flex-column mb-0 bg-white position-absolute top-50 end-0">
                <li
                  onClick={() => {
                    setshowDrop(false);
          ...
          <div id="buttons" className="d-flex flex-column "></div>
        </div>
        <div className="d-flex justify-content-around containerGeneral ">
