          ...
          <Col className=" d-sm border mb-5 mt-5 bg-white rounded col-md-6  pt-2">
            ...
            <div className="d-flex flex-wrap">
              <p
                ...
                style={{
                  border: liked ? (
                    /*Aggiungere componente  */ <HandThumbsUpFill />
                  ) : (
                    <HandThumbsUp />
                  ),
                }}
                className="align-items-start align-text-center me-3 interazioni p-1 pb-1"
              >
              ...
              <p
                ...
                style={{
                  border: selected
                    ? /*Aggiungere componente  */ "3px solid red"
                    : "none",
                }}
                className="align-items-start align-text-center me-3 interazioni p-1 pb-1"
              >
              ...
              <p className="align-items-start align-text-center me-3 interazioni p-1 pb-1 ">
                <Share className="align-center me-1" />
                Diffondi il post
              </p>
              <p className="align-items-start align-text-center interazioni p-1 pb-1">
